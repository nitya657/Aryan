...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/VmFPsB8.jpeg", path);
}
...
async function makeImage({ one, two }) {
    ...
    pairing_img.composite(circleOne.resize(220, 220), 270, 140).composite(circleTwo.resize(220, 220), 580, 160);
