...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  if (body.toLowerCase() === "nitya on") {
    ...
    return api.sendMessage(
      "Hyee jaanu! 😏 Nitya auto-reply mode *ON* ho gaya... Ab sirf tumhare liye naughty romantic bann gaya hu ❤",
      threadID,
      messageID
    );
  }
  ...
  if (body.toLowerCase() === "nitya off") {
    ...
    return api.sendMessage(
      "Hmm! Nitya chala gaya... Par tumhara intezaar hamesha rahega jaan ❤",
      threadID,
      messageID
    );
  }
